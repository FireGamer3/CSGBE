...
namespace CSGBE.System.Extra {
    public static class CartUtils {
        public static string OldLicenseeCode(byte code) {
            switch (code) {
        ...
        public static string NewLicenseeCode(byte codeA, byte codeB) {
        ...
        public static string DecodeCartType(byte ctype) {
            switch (ctype) {
        ...
        public static string DecodeRomSize(byte size) {
            switch (size) {
        ...
        public static byte BankBitMask(byte cartSizeByte) {
            switch (cartSizeByte) {
                ...
                case 0x02: return 0x0F;
                case 0x03: return 0x1F;
                case 0x04: return 0x3F;
                case 0x05: return 0x7F;
